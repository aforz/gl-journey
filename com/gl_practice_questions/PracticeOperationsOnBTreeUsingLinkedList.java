...
2.For every Right Node found for a parent node P in the binary tree
    1.Find the square of the right node.
    2.Perform Binary Delete operation on the parent node P.
    3.Find modulus 10 of square root and insert in binary tree.
Example:
...
public class PracticeOperationsOnBTreeUsingLinkedList {
    ...
    // delete the deepest rightmost node which is the rightmost node in last level of the tree
